...
export const Footer: React.FC = () => (
  <footer className="bg-gray-900 text-white px-4 py-8 text-base">
    <div className="max-w-6xl mx-auto flex flex-wrap justify-between items-start gap-8">
      ...
      <nav
        className="flex-1 min-w-[150px] flex flex-col gap-2 mb-4"
      ...
      >
        ...
        <a href="/privacy" className="hover:text-teal-400 transition-colors">Política de Privacidade</a>
      </nav>
    ...
    <div className="text-center mt-8 text-sm text-gray-400">
      &copy; {new Date().getFullYear()} ku_thola. Todos os direitos reservados.
    </div>
  </footer>
);
