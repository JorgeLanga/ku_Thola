...
Oferecemos ambiente flexível, suporte contínuo e possibilidade de crescimento na área.`,
  ...
  if (!job) {
    return (
      <div className="max-w-xl mx-auto mt-10 p-6 bg-red-50 border border-red-200 text-red-700 rounded">
  ...
  return (
    <div className="max-w-3xl mx-auto mt-10 bg-white shadow-md rounded-lg px-10 md:px-8 py-8">
